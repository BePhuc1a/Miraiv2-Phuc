module.exports.config = {
	...
	version: "1.0.0",
	hasPermssion: 0,
	credits: "hungdz30cm, ĐPhúc",
	description: "Những ảnh .... chất lượng\nMổi lần xem bạn phải trả 10000 đô!",
...
module.exports.run = async ({ api, event, Currencies }) => {
	...
	var data = await Currencies.getData(event.senderID);
      ...
      if(money < 10000) api.sendMessage("Bạn cần 10000 đô để xem ảnh\n(Có làm mới có ăn)",event.threadID,event.messageID)
         else {
    	...
    	let callback = function () {
					api.sendMessage({
						body: `REQUEST LEFT: ${u}\nSize: ${s}\r\n10000 đô đã biến mất khỏi túi của bạn!`,
